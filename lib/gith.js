...
(function() {
  ...
  Gith.prototype.simplifyPayload = function(payload) {
    var branch, rRef, refMatches, simpler, tag;
    payload = payload || {};
    branch = "";
    tag = "";
    ...
    simpler = {
      ...
      tag: tag,
      branch: branch,
      repo: (payload.repository ? (payload.repository.owner != null ? payload.repository.owner.name + "/" + payload.repository.name : payload.repository.name + "/" + payload.repository.name) : null),
      sha: payload.after,
